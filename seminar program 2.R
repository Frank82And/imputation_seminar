...
### Die Ausführung der Berechnungen kann jeweils einige Minuten in 
### Anspruch nehmen. Geduld ist also angebracht.
...
portfolio <- read_csv("C:/Users/Franky/Google Drive/Fernuni/Seminar/Program/dj1819.csv")
